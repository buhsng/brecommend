...
var DD_belatedPNG = {
    ns: "DD_belatedPNG", imgSize: {}, delay: 10, nodesFixed: 0, createVmlNameSpace: function () {
        ...
        if (b.styleSheet) {
            ...
            b.addRule("images." + this.ns + "_sizeFinder", "behavior:none; border:none; position:absolute; z-index:-1; top:-10000px; visibility:hidden;");
            ...
            a.addRule("images." + this.ns + "_sizeFinder", "{display: none !important;}")
        }
